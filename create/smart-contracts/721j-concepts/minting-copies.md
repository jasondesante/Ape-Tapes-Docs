...
Any token that's staked to the store is available for public minting. Also, anyone who holds a token can mint a copy of that token.  The copy will be the next generation of rarity from its parent.

The artist can mint copies one at a time to decide who gets them, or it can be staked and let anyone mint a copy.  The artist can distribute the "Gen 2" copies to the collaborators of the song, or use the rarity as high priced investor tier tokens to fund the project. Rarities are a way to be creative.

The supply of each generation can be visualized like a tree.

<figure><img src="../../../.gitbook/assets/image.png" alt=""><figcaption></figcaption></figure>

As you can see from this detailed render of a simulation there will be more tokens of a rarity the farther down it goes in generations.  In other words, the "Gen 2" will always be the most rare copy, and the 1/1 will be the most rare overall.  In the above simulation, the "Gen 4" tokens are the least rare.&#x20;
...
* mintOriginal - Creates an original with 1 piece of metadata.
* mintOriginalSplit - Same as mintOriginal, but lets you add a split address.
* mintOriginal3 - Creates an original with 3 pieces of metadata, for generations 1-3.&#x20;
* mintOriginal3Split - Same as mintOriginal3, but lets you add a split address.
...
* mintCopyTo - Same as mintCopy, plus add a wallet address that you will be sending the token to.&#x20;
...
MintCopyTo and mintCopyTokenTo both let you mint directly to someone else's wallet.  Like sharing music to a friend!
...
Staking is a button on the Create Copies page.  There's 2 functions that can stake, called togglePublicMint and togglePublicMints.  Which let you stake 1 or many tokens at once.  See [Staking](staking.md).

## Recycling

If recycling has been turned on, anyone can burn 2 tokens to mint a new one instead of using ETH. &#x20;
