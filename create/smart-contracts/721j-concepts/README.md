...
* Copies minted from the original. Minting a copy requires the minter to own a copy, or for the token to be staked.
...
Artist held originals are the reason for me making them.  The artist's wallet could be their digital discography which contains the original tokens of every song.  The wallet and contracts from the artist are an important thing in verifying whether or not you're looking at the genuine collection.
