...
* _**setPromo**_ - Sets a promo claim for a contract wide reward. Any token from an ERC-721 contract gets a reward.
* _**setPromoSpecific**_ - Sets a promo claim for a 721J specific reward. Any token from a 721J contract can get a reward based on it's song, rarity, or both.
