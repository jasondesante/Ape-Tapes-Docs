...
The Contract Wizard's Library is the name for the larger list of all the contracts that have been made by The Contract Wizard. &#x20;
...
The Contract Wizard's Library is an on chain, interoperable piece of an open source decentralized autonomous music network. In English that means its a list of record labels.  Crypto record labels. &#x20;

Uniquely owned by each artist, while the whole library can be treated as a set of collections.  If you do something for one, it works for all.  The library organizes a decentralized group of artists, while letting each artist do exactly what they want. &#x20;
