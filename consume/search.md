...
![](<../.gitbook/assets/Screenshot 2025-07-12 at 1.16.56 AM.png>)
...
![](<../.gitbook/assets/Screenshot 2025-07-12 at 1.17.56 AM.png>)

## Arweave Searching

For Arweave, you can switch the chain setting to Arweave and search using transaction IDs (tx\_ids). This enables you to find specific uploads, including **audio** files, **metadata** files, or **playlists**. If you are interested in searching Arweave tags, the Arweave Feed page is available.&#x20;

On the Arweave Feed page you can search for audio files and playlists using specific tags, providing a more targeted search option than just using tx\_ids.
