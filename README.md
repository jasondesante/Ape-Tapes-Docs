...
[**The Audio Uploader**](create/files/audio-uploader/) properly tags all files for maximum discoverability.

[**The Metadata Maker**](create/the-metadata-maker/) transforms basic audio files into rich, interactive music NFTs complete with artwork, tags, and more.

[**The Manifest Maker**](create/the-metadata-maker/manifest-maker/) helps you organize large collections efficiently.
...
Every contract created through The Contract Wizard joins [The Wizard's Library](create/tokens/the-contract-wizard/the-wizards-library.md) - a growing collection of independently owned record labels. What makes this powerful is interoperability: any feature built for one contract works for all contracts in the library.
...
The [721J](create/smart-contracts/721j-concepts/) is our enhanced version of the ERC721 standard, designed specifically for music. Key features include:
